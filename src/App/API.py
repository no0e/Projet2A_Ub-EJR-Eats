...
def run_app(reset_db=False):
    app = FastAPI(
        title="Ub’EJR Eats",
        description="This API allows you to connect as a customer, a delivery driver or an administrator to the ENSAI Junior Restaurant.<br>"
        "As a customer you can create a cart by choosing items from the menu. You can then order it.<br>"
        "As a delivery driver you can see the pendant orders and accept it. You will be provided a map with the itinary.<br>"
        "As an administrator, you can create, store and expose items with a price and category.",
    )
